...
.assistant-turn { margin:1.35rem 0 2.4rem; max-width:980px; }.assistant-label { color:var(--accent); font-size:.72rem; font-weight:750; letter-spacing:.06em; margin-bottom:.45rem; }.assistant-label i { font-style:normal; margin-right:.25rem; }.answer-copy { font-size:.97rem; line-height:1.8; color:#25344b; }
.citation { color:var(--accent); background:var(--accent-soft); border-radius:5px; padding:.08rem .35rem; font-size:.75em; font-weight:700; text-decoration:none; cursor:pointer; transition:all .2s ease; display:inline-block; }
.citation:hover { background:var(--accent); color:#fff; transform:scale(1.08); box-shadow:0 2px 6px rgba(39,89,214,.3); }
.reformulated-badge { display:inline-flex; align-items:center; gap:.35rem; font-size:.72rem; color:var(--accent); background:var(--accent-soft); padding:.2rem .65rem; border-radius:999px; margin-bottom:.65rem; font-weight:600; border:1px solid rgba(39,89,214,.18); }
.refusal { margin-top:.9rem; padding:.8rem .9rem; background:#fff6e8; border-radius:var(--radius-sm); color:#995c10; font-size:.8rem; }[data-testid="stVerticalBlockBorderWrapper"]{background:var(--surface);border-color:var(--line)!important;border-radius:var(--radius)!important;box-shadow:0 6px 18px rgba(34,56,95,.05)}
...
.source-card { display:grid; grid-template-columns:32px minmax(0,1fr); gap:.7rem; padding:1rem 0; border-top:1px solid var(--line); scroll-margin-top:90px; transition:all .3s ease; border-radius:var(--radius-sm); }
.source-card:target { border-left:4px solid var(--accent)!important; background:rgba(39,89,214,.08)!important; padding-left:.8rem; animation:highlight-pulse 2s ease-in-out 2 alternate; }
@keyframes highlight-pulse { 0% { background:rgba(39,89,214,.05); box-shadow:0 0 0 rgba(39,89,214,0); } 50% { background:rgba(39,89,214,.16); box-shadow:0 0 16px rgba(39,89,214,.35); } 100% { background:rgba(39,89,214,.08); box-shadow:0 0 6px rgba(39,89,214,.15); } }
.source-no { color:var(--accent); background:var(--accent-soft); width:26px; height:26px; display:grid; place-items:center; border-radius:7px; font-size:.7rem; font-weight:700; }.source-kicker { color:#8a96a8; font-size:.64rem; letter-spacing:.08em; }.source-title { font-size:.88rem; font-weight:700; margin:.22rem 0; overflow-wrap:anywhere; }.source-file,.source-meta { color:#7c899c; font-size:.7rem; overflow-wrap:anywhere; }.snippet { color:#5c6b80; font-size:.79rem; line-height:1.6; margin:.55rem 0; }.mock { color:#9a6414; background:#fff1d7; padding:.1rem .28rem; border-radius:4px; font-size:.58rem; }
...
[data-testid="stTabs"]{margin-top:1.35rem}[data-testid="stTabs"] button{font-size:.84rem;font-weight:650;color:var(--muted);padding:.75rem 1rem}[data-testid="stTabs"] button[aria-selected="true"]{color:var(--accent)}[data-testid="stMetric"]{background:var(--surface);border:1px solid var(--line);border-radius:var(--radius-sm);padding:.85rem 1rem}[data-testid="stMetricLabel"]{font-size:.72rem;color:var(--muted)}[data-testid="stMetricValue"]{font-size:1.35rem;color:var(--ink)}.document-sheet{margin-top:1rem;padding:1.2rem 1.3rem;background:var(--surface);border:1px solid var(--line);border-radius:var(--radius)}.retrieval-note{margin:1rem 0;padding:.8rem 1rem;background:var(--accent-soft);border-radius:var(--radius-sm);font-size:.82rem;color:#38517e}
